...
<body>
    ...
    <section id="popup">
        <article>
            ...
            <!--
            <div class="main-top-tak none">
            <h1 style="text-align: center">KONTAKT</h1>
            <p>1000 tak for beskeden, jeg vender tilbage hurtigst muligt. :)</p> <br><br> <p>Hvis du ik' lige syns det går hurtigt noc, kan du evt. prøve at fange mig i chatten :) </p><br>
